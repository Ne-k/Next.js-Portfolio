  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <p className="mt-6 text-base text-ink-soft">Hey, I&apos;m Cardin.</p>

        <h1 className="mt-2 max-w-[15ch] text-[clamp(2.5rem,8vw,4.5rem)] leading-[0.95] font-semibold tracking-[-0.035em] text-ink">
          I build backends, then take them apart.
        </h1>

        <div className="mt-14 grid gap-x-12 gap-y-12 lg:grid-cols-[minmax(0,1fr)_13rem]">
          <div className="min-w-0">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-x-3 gap-y-3">
              ...
              <a
                ...
                className="label border border-ink px-5 py-3 text-ink transition-colors hover:bg-ink hover:text-paper"
              >
                Resume (PDF)
              </a>
